...
export type CloseInput<
  ...
  TAccountVotingsolanadapp extends string = string,
> = {
...
>(
  input: CloseInput<TAccountPayer, TAccountVotingsolanadapp>,
  config?: { programAddress?: TProgramAddress }
): CloseInstruction<TProgramAddress, TAccountPayer, TAccountVotingsolanadapp> {
  // Program address.
  ...
  const instruction = {
    accounts: [
      ...
      getAccountMeta(accounts.votingsolanadapp),
    ],
    programAddress,
    data: getCloseInstructionDataEncoder().encode({}),
  } as CloseInstruction<TProgramAddress, TAccountPayer, TAccountVotingsolanadapp>;
...
> = {
  ...
  accounts: {
    ...
    votingsolanadapp: TAccountMetas[1];
  };
